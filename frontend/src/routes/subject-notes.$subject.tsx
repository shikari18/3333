      ...
      <main className="max-w-5xl mx-auto w-full px-4 md:px-6 py-6 flex-1">
        {chapters.length === 0 && !searchQuery.trim() ? (
          <div className="text-center py-16 bg-white rounded-3xl border border-slate-100 shadow-sm">
            ...
            <h2 className="font-bold text-lg text-slate-800">No Structured Chapters Yet</h2>
            <p className="text-slate-450 text-sm mt-2 max-w-sm mx-auto">
              We're polishing custom structured study guides for {subject}. Try searching topics in AI Notes!
            </p>
            <Link
              to="/notes"
              className="mt-5 inline-block px-6 py-3 rounded-full bg-primary text-white text-xs font-bold hover:opacity-95 shadow-md shadow-primary/25 transition-all"
            >
              Go to AI Search
            </Link>
          </div>
